...
import { ScreenWrapper, H2, H3, H4, InfoCard, DoubleDisplayCard, Button, P } from '../../Components';
import { Images, Colors } from '../../Theme';
import { __, formatPhone, isValidPhone } from '../../Utils/ReactHelpers'
import { getLanguageDataSelector } from '../../Redux/Modules/Localization'
import styles from './Styles/CityGuidesNoCityStyles';
import { getCounselorSelector, getDestinationAddressSelector } from '../../Redux/Modules/Relocation';
import S from '../../StyleUtils/';
import call from 'react-native-phone-call'
import { navigate } from '../../Redux/Modules/Routing'

class CityGuidesNoCity extends Component {
    constructor(props){
      super(props);
          ...
          <ScreenWrapper backgroundImage={Images.texture01}>
            <View style={ { flex: 1, justifyContent: 'space-between' } }>
                 <View style={[S.mtXxl]}>
                     ...
                     <P style={{textAlign: 'center', width: '90%', alignSelf: 'center'}}>{this.__('subtitle', destinationAddress.city)}</P>
                 </View>
...
const mapStateToProps = (state) => {
    return {
        screenLanguage: getLanguageDataSelector(state, 'CityGuidesNoCity'),
